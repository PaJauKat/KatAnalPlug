...
public class WeaponMap
{
    ...
    static
    {
        ...
        // SPEC
        StyleMap.put(ItemID._3RD_AGE_AXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID._3RD_AGE_PICKAXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_BLUDGEON, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_DAGGER, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_DAGGER_P, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_DAGGER_P_13269, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_DAGGER_P_13271, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_TENTACLE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_TENTACLE_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_WHIP, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_WHIP_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ABYSSAL_WHIP_20405, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ANCIENT_GODSWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ANCIENT_MACE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ARCLIGHT, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ARMADYL_GODSWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ARMADYL_GODSWORD_20593, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ARMADYL_GODSWORD_22665, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ARMADYL_GODSWORD_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.BANDOS_GODSWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.BANDOS_GODSWORD_20782, WeaponStyle.SPEC);
        StyleMap.put(ItemID.BANDOS_GODSWORD_21060, WeaponStyle.SPEC);
        StyleMap.put(ItemID.BANDOS_GODSWORD_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_AXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_AXE_23862, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_AXE_INACTIVE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HARPOON, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HARPOON_23864, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HARPOON_INACTIVE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_PICKAXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_PICKAXE_23863, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_PICKAXE_INACTIVE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_110, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_110_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_210, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_210_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_24125, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_310, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_310_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_410, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_410_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_510, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_510_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_610, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_610_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_710, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_710_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_810, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_810_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_910, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_910_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_ATTUNED, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_BASIC, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_FULL, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_FULL_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_INACTIVE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_HALBERD_PERFECTED, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DARKLIGHT, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DINHS_BULWARK, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_2H_SWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_2H_SWORD_20559, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_AXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_AXE_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_BATTLEAXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_CANE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_CLAWS, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_CLAWS_20784, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_DAGGER, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_DAGGER_20407, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_DAGGERP, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_DAGGERP_5680, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_DAGGERP_5698, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HALBERD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HARPOON, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HARPOON_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HASTA, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HASTAKP, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HASTAP, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HASTAP_22737, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HASTAP_22740, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_HUNTER_LANCE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_LONGSWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_MACE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_PICKAXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_PICKAXE_12797, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_PICKAXE_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_PICKAXE_OR_25376, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_SCIMITAR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_SCIMITAR_20406, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_SCIMITAR_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_SPEAR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_SPEARP, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_SPEARP_5716, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_SPEARP_5730, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_SWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_WARHAMMER, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_WARHAMMER_20785, WeaponStyle.SPEC);
        StyleMap.put(ItemID.FROZEN_ABYSSAL_WHIP, WeaponStyle.SPEC);
        StyleMap.put(ItemID.GRANITE_HAMMER, WeaponStyle.SPEC);
        StyleMap.put(ItemID.GRANITE_MAUL, WeaponStyle.SPEC);
        StyleMap.put(ItemID.GRANITE_MAUL_12848, WeaponStyle.SPEC);
        StyleMap.put(ItemID.GRANITE_MAUL_20557, WeaponStyle.SPEC);
        StyleMap.put(ItemID.GRANITE_MAUL_24225, WeaponStyle.SPEC);
        StyleMap.put(ItemID.GRANITE_MAUL_24227, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_AXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_AXE_UNCHARGED, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_AXE_UNCHARGED_25371, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_HARPOON, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_HARPOON_UNCHARGED, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_HARPOON_UNCHARGED_25367, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_PICKAXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_PICKAXE_UNCHARGED, WeaponStyle.SPEC);
        StyleMap.put(ItemID.INFERNAL_PICKAXE_UNCHARGED_25369, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_HALBERD_FULL, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_HALBERD_FULL_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_HALBERD_FULL_16893, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_HALBERD_FULL_I_16892, WeaponStyle.SPEC);
        StyleMap.put(ItemID.RUNE_CLAWS, WeaponStyle.SPEC);
        StyleMap.put(ItemID.SARADOMIN_GODSWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.SARADOMIN_GODSWORD_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.STATIUSS_WARHAMMER, WeaponStyle.SPEC);
        StyleMap.put(ItemID.STATIUSS_WARHAMMER_23620, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VESTAS_BLIGHTED_LONGSWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VESTAS_LONGSWORD_INACTIVE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VESTAS_LONGSWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VESTAS_LONGSWORD_23615, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VESTAS_SPEAR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ZAMORAK_GODSWORD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ZAMORAK_GODSWORD_OR, WeaponStyle.SPEC);

        StyleMap.put(ItemID.ARMADYL_CROSSBOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ARMADYL_CROSSBOW_23611, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_110, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_110_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_210, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_210_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_310, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_310_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_410, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_410_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_510, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_510_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_610, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_610_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_710, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_710_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_810, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_810_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_910, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_910_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_24123, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_ATTUNED, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_BASIC, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_FULL, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_FULL_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_INACTIVE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.CRYSTAL_BOW_PERFECTED, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DARK_BOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DARK_BOW_12765, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DARK_BOW_12766, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DARK_BOW_12767, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DARK_BOW_12768, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DARK_BOW_20408, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DORGESHUUN_CROSSBOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_CROSSBOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_KNIFE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_KNIFEP, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_KNIFEP_22808, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_KNIFEP_22810, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DRAGON_THROWNAXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.HEAVY_BALLISTA, WeaponStyle.SPEC);
        StyleMap.put(ItemID.HEAVY_BALLISTA_23630, WeaponStyle.SPEC);
        StyleMap.put(ItemID.LIGHT_BALLISTA, WeaponStyle.SPEC);
        StyleMap.put(ItemID.MAGIC_COMP_BOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.MAGIC_LONGBOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.MAGIC_SHORTBOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.MAGIC_SHORTBOW_20558, WeaponStyle.SPEC);
        StyleMap.put(ItemID.MAGIC_SHORTBOW_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.MORRIGANS_JAVELIN, WeaponStyle.SPEC);
        StyleMap.put(ItemID.MORRIGANS_JAVELIN_23619, WeaponStyle.SPEC);
        StyleMap.put(ItemID.MORRIGANS_THROWING_AXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_BOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_BOW_4213, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_BOW_16888, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_BOW_I, WeaponStyle.SPEC);
        StyleMap.put(ItemID.NEW_CRYSTAL_BOW_I_16889, WeaponStyle.SPEC);
        StyleMap.put(ItemID.RUNE_THROWNAXE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.SEERCULL, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ZARYTE_CROSSBOW, WeaponStyle.SPEC);

        StyleMap.put(ItemID.BLISTERWOOD_FLAIL, WeaponStyle.SPEC);
        StyleMap.put(ItemID.DAWNBRINGER, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ELDRITCH_NIGHTMARE_STAFF, WeaponStyle.SPEC);
        StyleMap.put(ItemID.IVANDIS_FLAIL, WeaponStyle.SPEC);
        StyleMap.put(ItemID.STAFF_OF_LIGHT, WeaponStyle.SPEC);
        StyleMap.put(ItemID.STAFF_OF_THE_DEAD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.STAFF_OF_THE_DEAD_23613, WeaponStyle.SPEC);
        StyleMap.put(ItemID.TOXIC_BLOWPIPE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.TOXIC_BLOWPIPE_EMPTY, WeaponStyle.SPEC);
        StyleMap.put(ItemID.TOXIC_STAFF_OF_THE_DEAD, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VOLATILE_NIGHTMARE_STAFF, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VOLATILE_NIGHTMARE_STAFF_25517, WeaponStyle.SPEC);
        StyleMap.put(ItemID.OSMUMTENS_FANG, WeaponStyle.SPEC);
        StyleMap.put(ItemID.OSMUMTENS_FANG_OR, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VOIDWAKER_27869, WeaponStyle.SPEC);
        StyleMap.put(ItemID.VOIDWAKER, WeaponStyle.SPEC);
        StyleMap.put(ItemID.WEBWEAVER_BOW, WeaponStyle.SPEC);
        StyleMap.put(ItemID.WEBWEAVER_BOW_U, WeaponStyle.SPEC);
        StyleMap.put(ItemID.URSINE_CHAINMACE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.URSINE_CHAINMACE_U, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ACCURSED_SCEPTRE, WeaponStyle.SPEC);
        StyleMap.put(ItemID.ACCURSED_SCEPTRE_U, WeaponStyle.SPEC);
        StyleMap.put(ItemID.KERIS_PARTISAN_OF_THE_SUN, WeaponStyle.SPEC);
        StyleMap.put(ItemID.KERIS_PARTISAN_OF_CORRUPTION, WeaponStyle.SPEC);
    }
}